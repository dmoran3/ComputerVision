...
void test_coords(Image *an_image);

//H2
void MakeBinary(int threshold, Image *an_image);

void GenerateHoughArray(Image *an_image, int threshold, std::string text_file);

int GetLocalAverage(int i, int j, Image *an_image);

void GenerateHoughImage(int hough_array[][180], int max_rho, int max_val, Image *an_image, std::string text_file);
